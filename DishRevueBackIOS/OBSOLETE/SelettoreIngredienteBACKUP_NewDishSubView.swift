...
struct SelettoreIngredienteBACKUP_NewDishSubView: View {
...
struct SelettoreIngredienteBACKUP_NewDishSubView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        ...
        ZStack {
            ...
            SelettoreIngredienteBACKUP_NewDishSubView(propertyVM: propertyVM, newDish: .constant(DishModel()))
            ...
            SelettoreIngredienteBACKUP_NewDishSubView_Previews.test()
        }
...
struct MostraOrdinamentoIngredientiGenericsBACKUP<G:IngredientConformation>:View {
...
struct MostraSelettoreIngredientiGenericsBACKUP<G:IngredientConformation>:View {
...
enum ListSwitcherBACKUP: String {
...
struct ListaIngredientiAttivaBACKUP_GenericView: View {
