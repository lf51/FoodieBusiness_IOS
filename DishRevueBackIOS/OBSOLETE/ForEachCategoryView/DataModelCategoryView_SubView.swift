           ...
           ScrollView(showsIndicators: false){
               ...
               ScrollViewReader { proxy in
                   ...
                   ForEach(csDataMapping(), id:\.self) { category in
                       ...
                       CSLabel_1Button(placeHolder: category.simpleDescription(), imageNameOrEmojy: category.imageAssociated(), backgroundColor: Color.seaTurtle_1, backgroundOpacity: 0.3)
