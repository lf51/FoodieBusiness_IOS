...
// Teoricamente questa enum ha senso per messaggi uguali ripetuti. L'unico che viene ripetuto è quello degli allergeni.
    ...
    func simpleDescription() -> String {
        ...
        case .formattazioneInserimentoVeloceCategorie:
            return "E' possibile inserire contemporaneamente un numero imprecisato di categorie. La stringa deve seguire il seguente schema:\n\nNome categoria 1,categoria 2,categoria 3, ecc.\nEsempio:\nAntipasti,primi,secondi,burger,dolci,frutaa.\n\nE' preferibile non usare spazi fra le punteggiature.\nIl punto non è riconosciuto come un segno di separazione e sarà incluso nel nome della categoria."
