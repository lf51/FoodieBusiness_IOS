...
// Teoricamente questa enum ha senso per messaggi uguali ripetuti. L'unico che viene ripetuto è quello degli allergeni.
    ...
    case formattazioneInserimentoVeloceCategorie
    ...
    func simpleDescription() -> String {
        ...
        case .sostituzioneTemporaneaING:
            return "L'utente ha qui la facoltà di indicare un sostituto temporaneo che rimpiazzerà l'ingrediente ogni qual volta il suo stato scorte sarà impostato su 'esaurito'.\nIl cambio può essere unico, ossia un solo sostituto per tutti i prodotti, oppure per ciascun prodotto si potrà scegliere un sostituto differente o nessuno.\n\nNella lista ingredienti di ciascun prodotto saranno così visualizzati entrambi gli elementi, l'ingrediente sostituito (reciso) e il sostituto (fra parentesi), fino a quando lo stato scorte dell'ingrediente carente non sarà posto 'in stock'.\n\nLa sostituzione temporanea potrà servire a mantenere l'eseguibilità del prodotto, e potrà modificare temporaneamente le qualità del prodotto in termini di diete, allergeni e quant'altro."
            
        case .sostituzionePermanenteING:
            return "L'utente può qui sostituire in modo permanente un ingrediente da tutti i prodotti che lo contengono o da una parte di essi. Qualora la sostituzione riguardi tutti i prodotti, l'ingrediente sarà posto 'fuori inventario' e si potrà poi procedere alla sua eliminazione.\n\nIl cambio può essere unico, ossia un solo sostituto per tutti i prodotti, oppure per ciascun prodotto si può scegliere di mantenerlo o sostituirlo."
        ...
        case .formattazioneInserimentoVeloceCategorie:
            return "E' possibile inserire contemporaneamente un numero imprecisato di categorie. La stringa deve seguire il seguente schema di esempio:\nantipasti,primi,secondi,burger,dolci,frutta\n\nE' preferibile non usare spazi fra le punteggiature.\nIl punto non è riconosciuto come un segno di separazione e sarà incluso nel nome della categoria."
