    ...
    init(
     ...
     //   percorso:DishModel.PercorsoProdotto,// deprecatp
       ...
       // let localDish: DishModel
        let systemIngredient: IngredientModel = observedVM.modelFromId(id: wrappedNewDish.id, modelPath: \.cloudData.allMyIngredients) ?? IngredientModel(id: wrappedNewDish.id)
