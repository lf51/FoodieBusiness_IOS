...
struct CategoriaScrollView_NewDishSub: View {
    ...
    var body: some View {
        ...
        VStack(alignment: .leading,spacing: .vStackLabelBodySpacing) {
            ...
            PropertyScrollCases_Rif(cases:viewModel.cloudData.allMyCategories, dishSingleProperty: self.$newDish.categoriaMenu, colorSelection: Color.green.opacity(0.8))
             //   .padding(.top,5)
