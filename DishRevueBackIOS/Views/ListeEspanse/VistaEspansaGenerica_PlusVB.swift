    ...
    var body: some View {
        ...
        CSZStackVB(title: label, backgroundColorView: backgroundColorView) {
            ...
            let containerModel:[IngredientModel] = {
                    ...
                    let model = self.viewModel.modelCollectionFromCollectionID(
                        collectionId: container,
                        modelPath: \.currentProperty.db.allMyIngredients)
                    let filteredModel = self.viewModel.filtraSpecificCollection(
                        ofModel: model,
                        coreFilter: coreFilter)
                    return filteredModel
           ...
           backgroundColorView: backgroundColorView) {
               ...
               let containerModel:[DishModel] = {
                   ...
                   let ingModel = self.viewModel.modelCollectionFromCollectionID(
                       collectionId: container,
                       modelPath: \.currentProperty.db.allMyIngredients) // i pf hanno un ingrediente con stesso id
                   ...
                   let dishModel = self.viewModel.modelCollectionFromCollectionID(collectionId: filteredId, modelPath: \.currentProperty.db.allMyDish)
