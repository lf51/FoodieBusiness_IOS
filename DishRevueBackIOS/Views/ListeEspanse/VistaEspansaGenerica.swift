   ...
   // let containerPath:KeyPath<FoodieViewModel,[DishModel]>
    ...
    var body: some View {
        ...
        CSZStackVB(title: label, backgroundColorView: backgroundColorView) {
            ...
            let container = self.viewModel.modelCollectionFromCollectionID(collectionId: rifDishes, modelPath: \.currentProperty.db.allMyDish).sorted(by: {$0.intestazione < $1.intestazione})
