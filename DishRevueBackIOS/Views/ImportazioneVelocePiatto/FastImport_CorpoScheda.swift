                ...
                VStack(alignment:.leading) {
                    ...
                    HStack {
                        ...
                        CS_Picker(
                            ...
                            dataContainer: viewModel.currentProperty.db.allMyCategories,//CategoriaMenu.allCases,
           ...
           // ScrollView(showsIndicators: false) {
                ...
                ForEach($temporaryModel.ingredients) { $ingredient in
                  ...
                  /*  let isIngredientOld = viewModel.checkExistingUniqueModelID(model: ingredient).0 */
                    let isIngredientOld = viewModel.isTheModelAlreadyExist(modelID: ingredient.id,path: \.currentProperty.db.allMyIngredients)
