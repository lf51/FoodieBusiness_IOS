    ...
    var body: some View {
        ...
        VStack {
            ...
            ForEach(allFastCategories) { category in
                ...
                let alreadyExist = self.viewModel.isTheModelAlreadyExist(modelID: category.id, path: \.currentProperty.db.allMyCategories)
        ...
        .onAppear {
            ...
            if let newFocus = self.allFastCategories.first(where: {!self.viewModel.isTheModelAlreadyExist(modelID: $0.id, path: \.currentProperty.db.allMyCategories)}) {
